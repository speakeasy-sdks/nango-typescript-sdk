...
export type PutProxyRequest = {
    ...
    putProxyRequest?: components.PutProxyRequest | undefined;
};

export type PutProxyResponse = {
    /**
...
export namespace PutProxyRequest$ {
    export type Inbound = {
        ...
        PutProxyRequest?: components.PutProxyRequest$.Inbound | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<PutProxyRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            PutProxyRequest: components.PutProxyRequest$.inboundSchema.optional(),
        })
        .transform((v) => {
            return {
                anyPath: v.anyPath,
                ...
                ...(v.PutProxyRequest === undefined
                    ? null
                    : { putProxyRequest: v.PutProxyRequest }),
            };
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PutProxyRequest> = z
        .object({
            ...
            putProxyRequest: components.PutProxyRequest$.outboundSchema.optional(),
        })
        .transform((v) => {
            return {
                anyPath: v.anyPath,
...
/** @internal */
export namespace PutProxyResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
    ...
    export const inboundSchema: z.ZodType<PutProxyResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PutProxyResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
