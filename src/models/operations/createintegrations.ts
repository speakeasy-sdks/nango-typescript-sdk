...
export type CreateIntegrationsResponse = {
    /**
...
/** @internal */
export namespace CreateIntegrationsResponse$ {
    export const inboundSchema: z.ZodType<CreateIntegrationsResponse, z.ZodTypeDef, unknown> = z
        .object({
        ...
        .transform((v) => {
            return remap$(v, {
                ...
                IntegrationsResponse200: "integrationsResponse200",
            });
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateIntegrationsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
