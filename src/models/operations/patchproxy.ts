...
export namespace PatchProxyRequest$ {
    export type Inbound = {
        ...
        PatchProxyRequest?: components.PatchProxyRequest$.Inbound | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<PatchProxyRequest, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.PatchProxyRequest === undefined
                    ? null
                    : { patchProxyRequest: v.PatchProxyRequest }),
            };
        });
...
export namespace PatchProxyResponse$ {
    ...
    export const inboundSchema: z.ZodType<PatchProxyResponse, z.ZodTypeDef, Inbound> = z
        .object({
