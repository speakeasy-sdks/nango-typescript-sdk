...
export namespace DeleteProxyRequest$ {
    ...
    export const inboundSchema: z.ZodType<DeleteProxyRequest, z.ZodTypeDef, Inbound> = z
        .object({
            anyPath: z.string(),
...
export namespace DeleteProxyResponse$ {
    ...
    export const inboundSchema: z.ZodType<DeleteProxyResponse, z.ZodTypeDef, Inbound> = z
        .object({
