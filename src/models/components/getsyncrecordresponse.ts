...
export namespace LastAction$ {
    export const inboundSchema: z.ZodNativeEnum<typeof LastAction> = z.nativeEnum(LastAction);
    export const outboundSchema: z.ZodNativeEnum<typeof LastAction> = inboundSchema;
}
