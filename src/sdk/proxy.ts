...
export class Proxy extends ClientSDK {
     ...
     * Make a GET request with the Proxy.
     */
    async get(request: operations.GetProxyRequest, options?: RequestOptions): Promise<void> {
        const input$ = request;
     ...
     * Make a POST request with the Proxy.
     */
    async create(request: operations.CreateProxyRequest, options?: RequestOptions): Promise<void> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
     ...
     * Make a PUT request with the Proxy.
     */
    async update(request: operations.PutProxyRequest, options?: RequestOptions): Promise<void> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Content-Type", "application/json");
     ...
     * Make a PATCH request with the Proxy.
     */
    async modify(request: operations.PatchProxyRequest, options?: RequestOptions): Promise<void> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Content-Type", "application/json");
     ...
     * Make a DELETE request with the Proxy.
     */
    async delete(request: operations.DeleteProxyRequest, options?: RequestOptions): Promise<void> {
        const input$ = request;
        const headers$ = new Headers();
        headers$.set("user-agent", SDK_METADATA.userAgent);
        headers$.set("Accept", "*/*");
